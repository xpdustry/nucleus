 ...
 */
package fr.xpdustry.nucleus.discord.configuration;
...
@Config.Sources("classpath:nucleus.properties")
@Config.LoadPolicy(LoadType.FIRST)
public interface NucleusDiscordConfiguration extends NucleusConfiguration {
