...
public final class SimpleInteractionManager implements InteractionManager, NucleusListener {
    ...
    @Inject
    public SimpleInteractionManager(final DiscordService discordService) {
    ...
    private CompletableFuture<Set<ApplicationCommand>> compile() {
        ...
        return discordService
                .getDiscordApi()
                .bulkOverwriteServerApplicationCommands(discordService.getMainServer(), compiled);
    }
